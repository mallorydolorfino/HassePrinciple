...
For the product formula, we introduce the following notation.
Let $p$ be a prime number. For $a, b \in \Q^\times$, we let $(a, b)_p$ be the Hilbert symbol
$(a,b)_{\Q_p}$ computed in $\Q_p$.
We moreover let $(a, b)_\infty$ be the Hilbert symbol $(a,b)_{\R}$ computed in $\R$.
